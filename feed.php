...
header('Content-Type: text/rss2; charset=utf-8', true);
...
<channel>
	...
	<item>
		...
		<dc:creator><![CDATA['.the_author_meta('display_name', $p->post_author).']]></dc:creator>
		<category><![CDATA[<?php'.get_the_category($p->ID)[0]->name.']]></category>

		<guid isPermaLink="false">"http://mtulode.com/?p='.$p->ID.'</guid>
		<description><![CDATA['.substr($p->post_content, 0, 360).']]></description>
...
file_put_contents("feed.xml", $xml_string);
echo "feed submitted to feed.xml";